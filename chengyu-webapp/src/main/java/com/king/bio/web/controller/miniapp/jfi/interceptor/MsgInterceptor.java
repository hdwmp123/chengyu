...
package com.king.bio.web.controller.miniapp.jfi.interceptor;
...
/**
 * Msg 拦截器
 * 1：通过 WxaMsgController.getApiConfig() 得到 ApiConfig 对象，并将其绑定到当前线程之上(利用了 ApiConfigKit 中的 ThreadLocal 对象)
 * 2：响应开发者中心服务器配置 URL 与 Token 请求
 * 3：签名检测
 * 注意： WxaMsgController 的继承类如果覆盖了 index 方法，则需要对该 index 方法声明该拦截器
...
public class MsgInterceptor implements Interceptor {
    ...
    public void intercept(Invocation inv) {
        ...
        try {
            ...
            String appId = WxaConfigKit.getWxaConfig().getAppId();
