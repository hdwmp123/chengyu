...
public abstract class BaseValidator extends Validator {
     ...
     * Validate date.
     */
    protected void validateDatetime(Controller controller, String field, Date min, Date max, String errorKey,
            String errorMessage) {
        try {
            String value = controller.getPara(field);
            // Date temp = Date.valueOf(value); 为了兼容 64位 JDK
            Date temp = new SimpleDateFormat(datetimePattern).parse(value);
     ...
     */
    protected void validateDatetime(Controller controller, String field, String min, String max, String errorKey,
            String errorMessage) {
