package com.king.bio.web.common;
...
public class CommonRealm extends AuthorizingRealm {
     ...
     */
    protected static final String DEFAULT_AUTHENTICATION_QUERY = "SELECT pwd FROM sys_user_info WHERE username=?";

    /**
     * The default query used to retrieve the roles that apply to a user.
     */
    protected static final String DEFAULT_USER_ROLES_QUERY = "SELECT role_id FROM sys_role_user WHERE username=?";

    /**
     * The default query used to retrieve permissions that apply to a particular
     * role. select permission from roles_permissions where role_name = ?
     */
    protected static final String DEFAULT_PERMISSIONS_QUERY = "SELECT tname FROM sys_role_moudle WHERE role_id=?";
    ...
    /**
     * 此方法是为用户加Role、permission的 This implementation of the interface expects the
