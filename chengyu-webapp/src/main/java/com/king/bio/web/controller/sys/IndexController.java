...
public class IndexController extends BaseController {
    ...
    public void validateLogin() {
        SysUserInfo user = getModel(SysUserInfo.class, "userinfo");
        UsernamePasswordToken token = new UsernamePasswordToken(
                user.getStr("username"), user.getStr("pwd"));
        try {
            ...
            SysUserInfo loginUser = SysUserInfo.dao.findFirst(
            ...
            // TODO: Thrown when a system is configured to only allow a certain
    ...
    public void main() {
        Subject subject = SecurityUtils.getSubject();
        Session session = subject.getSession(true);
        SysUserInfo loginUser = (SysUserInfo) session.getAttribute("loginUser");
