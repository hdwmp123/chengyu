...
public class ChineseNumberUtil {
    ...
    public static String CurrencyToBigRMB(long __fen) {
        ...
        if (strCurrency.length() < 3) {
            ...
            return ("零" + strYuan + getBigWrite(strCurrency.substring(0, 1)) + "角"
                    + getBigWrite(strCurrency.substring(1)) + "分");
        }
        ...
        if (smallFloat.equals("0") || smallFloat.equals("00")) {
            ...
            strXiaoShu = getBigWrite(smallFloat.substring(0, 1)) + "角" + getBigWrite(smallFloat.substring(1)) + "分";
        }
        ...
        for (int i = 0; i < 3; i++) {
            if (!"U".equals(strPerNum[i])) {
                if ("0".equals(strPerNum[i])) {
                    ...
                    strResult = strResult + getSmallWrite(strPerNum[i]) + unit2[i];
                }
            }
        }
        // 个位
        ...
        for (int i = 0; i < 3; i++) {
            if (!"U".equals(strPerNum[i])) {
                if ("0".equals(strPerNum[i])) {
                    ...
                    strResult = strResult + getBigWrite(strPerNum[i]) + unit2[i];
                }
            }
        }
        // 个位
    ...
    public static String getBigInt(String strNum) {
        ...
        String[] unit = { "万", "亿" };
        String[] strZero = { "000000000000000", "00000000000000", "0000000000000", "000000000000", "00000000000",
