...
public class SerialNumberUtil {
    ...
    static {
        ...
        // lastOrderSnNumber =
        // Long.parseLong(MigrStringUtil.removeStartIgnoreCase(lastOrderSn,
        // ORDER_SN_PREFIX));
        // } else {
        ...
        // SpringUtil.getBean("paymentServiceImpl");
        // String lastPaymentSn = paymentService.getLastPaymentSn();
        // if (MigrStringUtil.isNotEmpty(lastPaymentSn)) {
        // lastPaymentSnNumber =
        // Long.parseLong(MigrStringUtil.removeStartIgnoreCase(lastPaymentSn,
        // PAYMENT_SN_PREFIX));
        // } else {
        ...
        // SpringUtil.getBean("refundServiceImpl");
        // String lastRefundSn = refundService.getLastRefundSn();
        // if (MigrStringUtil.isNotEmpty(lastRefundSn)) {
        // lastRefundSnNumber =
        // Long.parseLong(MigrStringUtil.removeStartIgnoreCase(lastRefundSn,
        // REFUND_SN_PREFIX));
        // } else {
        ...
        // SpringUtil.getBean("shippingServiceImpl");
        // String lastShippingSn = shippingService.getLastShippingSn();
        // if (MigrStringUtil.isNotEmpty(lastShippingSn)) {
        // lastShippingSnNumber =
        // Long.parseLong(MigrStringUtil.removeStartIgnoreCase(lastShippingSn,
        // SHIPPING_SN_PREFIX));
        // } else {
        ...
        //
        // // 退货编号
        // ReshipService reshipService = (ReshipService)
        // SpringUtil.getBean("reshipServiceImpl");
        // String lastReshipSn = reshipService.getLastReshipSn();
        // if (MigrStringUtil.isNotEmpty(lastReshipSn)) {
        // lastReshipSnNumber =
        // Long.parseLong(MigrStringUtil.removeStartIgnoreCase(lastReshipSn,
        // RESHIP_SN_PREFIX));
        // } else {
