...
public class MessageUtil {
     ...
     */
    public static String sendMessage(String mobilesNo, String content) throws IOException, HttpException {
        ...
        try {
            ...
            NameValuePair data[] = { new NameValuePair("userid", SMSProperties.getProperty("userid")),
                    new NameValuePair("account", SMSProperties.getProperty("account")),
                    new NameValuePair("password", SMSProperties.getProperty("password")),
                    new NameValuePair("mobile", mobilesNo), new NameValuePair("content", content),
                    new NameValuePair("sendTime", ""), new NameValuePair("action", "send"),
                    new NameValuePair("checkcontent", "0"), new NameValuePair("taskName", ""),
                    new NameValuePair("countnumber", "1"), new NameValuePair("mobilenumber", "1"),
